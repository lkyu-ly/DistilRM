...
class JointDataCollatorWithPadding:
    ...
    def __call__(self, features: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for feature in features:
            ...
            label_paded.extend(
                [label_chosen_paded.view(1, -1), label_rejected_paded.view(1, -1)]
            )
    ...
    def compute_loss(self, model, inputs, return_outputs=False, **kwargs):
        ...
        if self.sft_weight > 0 and self.teacher_model is not None:
            ...
            for b in range(batch_size):
                ...
                teacher_attention_mask_batch = inputs["teacher_attention_mask"][
                    b : b + 1
                ]
        ...
        if self.kl_weight > 0 and self.teacher_model is not None:
            ...
            for b in range(batch_size):
                ...
                teacher_slice = teacher_logits[
                    b : b + 1, teacher_prefix_len : teacher_prefix_len + min_len, :
                ]
                student_slice = kl_logits[
                    b : b + 1, student_prefix_len : student_prefix_len + min_len, :
                ]
                ...
                teacher_response_tokens = teacher_input_ids_batch[
                    0, teacher_prefix_len : teacher_prefix_len + min_len
                ]
                shift_labels = teacher_response_tokens.unsqueeze(0)
                kl_mask = (shift_labels != self.tokenizer.pad_token_id).to(
